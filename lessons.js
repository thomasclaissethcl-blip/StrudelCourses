window.COURSE = {
  "meta": {
    ...
    "version": "1.3",
    "language": "fr",
    "description": "Module micro learning pour apprendre Strudel par la pratique, avec chargement explicite des samples Dirt-Samples, tempo corrigé, progression locale et parcours stylistiques complets.",
          ...
          "lessons": [
            {
              ...
              "concept": "Avant les samples, on teste un son synthétique. Un synthé comme sine ne dépend pas du chargement d’un fichier audio. Le motif utilise quatre notes dans le cycle pour produire un son rapidement après le lancement.",
              ...
              "whatToListenFor": "Vous devez entendre une note par seconde environ. Si vous entendez cette ligne simple, le moteur audio fonctionne.",
          ...
          "lessons": [
            {
              ...
              "concept": "Dans ce module, les exercices rythmiques ne supposent pas que la carte de samples par défaut soit déjà disponible. La première ligne charge explicitement Dirt-Samples, puis s(\"...\") joue les sons. Les noms bd, sd, hh et cp désignent respectivement grosse caisse, caisse claire, charley fermé et clap.",
              ...
              "hintLevel1": "Ne modifiez pas la première ligne. Elle charge la banque de samples.",
              "hintLevel2": "Remplacez bd par sd dans s(\"bd*4\").",
              "solution": "samples('https://raw.githubusercontent.com/tidalcycles/Dirt-Samples/master/strudel.json')\n\nsetcpm(100/4)\n// 100 BPM perçu, 4 temps par cycle\n\ns(\"sd*4\")",
              ...
              "commonMistake": "L’erreur la plus fréquente est de supprimer la ligne samples(...). Sans elle, cet exercice peut redevenir dépendant du comportement par défaut du REPL.",
              "summary": "Vous savez distinguer la ligne de chargement des samples et la ligne qui décrit le motif musical.",
  ...
  "projects": [
    {
      ...
      "technicalChecklist": [
        "Le code contient setcpm(BPM/4) pour fixer le tempo perçu.",
        "Chaque couche a un rôle identifiable.",
        "La ligne samples(...) est présente avant les patterns à samples.",
